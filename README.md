...
- **Full detail/edit screen** - title, author, series and series number, category, status, star rating (1-5, color-coded), where you have it (tap "+ Add" for a quick picker of Kindle, Kobo, Library, or Personal - a book can have more than one), synopsis, and free-text notes
